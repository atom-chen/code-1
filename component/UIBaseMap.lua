...
--    logger:info("BaseMap onTouchBegan")
    ...
    self.scene:stopAllActions() --先停止动画
...
--    logger:info("BaseMap onTouchEnd")
    ...
    if (not self.isTouchMoved)
        or (dis < self.ignoreMove)
    then
...
--    self.scene:addChild(child, 0, 999)
--end
