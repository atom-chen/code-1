...
--    end
    ...
    local effectPath = cc.FileUtils:getInstance():fullPathForFilename("sounds/" .. name .. "." .. filetype)
...
function AudioManager:playButtonEffect()
    ...
    local name = "Button"
    local effectPath = cc.FileUtils:getInstance():fullPathForFilename("sounds/" .. name .. "." .. AudioManager.defaultSoundType)
    AudioEngine.playEffect(effectPath)
end
...
function AudioManager:playMusic(name, filetype, forcePlay)
    ...
    self._musicName = name
    filetype = filetype or AudioManager.defaultSoundType
    local musicPath = cc.FileUtils:getInstance():fullPathForFilename("sounds/" .. name .. "." .. filetype)
