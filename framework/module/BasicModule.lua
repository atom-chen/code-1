...
function BasicModule:showAction()    
    ...
    local function callback()
        ...
        -- local srcX , srcY = self.parent:getPosition()
        -- self.parent:setPosition(srcX, srcY)
        -- print("~~~~~~~~~~移动完毕~~~~~~~~~~~")
...
function BasicModule:showMessageBox(content, okCallback, canCelcallback,okBtnName,canelBtnName)
    return self._gameState:showMessageBox(content, okCallback, canCelcallback,okBtnName,canelBtnName)
end
