...
--提示框
function BasicProxy:showMessageBox(content, okCallback, canCelcallback,okBtnName,canelBtnName)
    local state = self._game:getCurState()
    state:showMessageBox(content, okCallback, canCelcallback,okBtnName,canelBtnName)
end
