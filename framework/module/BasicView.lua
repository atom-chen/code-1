...
function BasicView:showMessageBox(content, okCallback, canCelcallback,okBtnName,canelBtnName)
    return self._parent.module:showMessageBox(content, okCallback, canCelcallback,okBtnName,canelBtnName)
end
